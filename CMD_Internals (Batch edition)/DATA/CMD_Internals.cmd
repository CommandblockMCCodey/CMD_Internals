...
if "!userInput!" equ "Tools." (
    ...
    if "!userInput2!" equ "" (
        ...
        pause
        goto start
    ) else if "!userInput2!" equ "CMD" (
        echo start buildin CMD...
        echo.
        :cmd
        set /p "setCommand=CMD> "
        ...
        echo Tools:
        echo DIR IPCONFIG  WHOIS  CMD  HELP BACK
        pause
        goto start
    ) else (
